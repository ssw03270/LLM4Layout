...
def main():
    # 원본 데이터 폴더 (현재 작업 경로)
    gt_base_dir = "./outputs/ours/layout_output/threed_front_bedroom"  # 실제 폴더 경로에 맞게 수정
    pred_base_dir = "./outputs/ours/layout_output/threed_front_bedroom"  # ours
    # pred_base_dir = "./outputs/layout_gpt/image_output"  # ours
