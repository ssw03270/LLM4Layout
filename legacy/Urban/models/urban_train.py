...
if __name__ == "__main__":
    ...
    train_dataset = data_utils.UrbanDataset(split_dataset_paths, "train")
    val_dataset = data_utils.UrbanDataset(split_dataset_paths, "val")
    ...
    for epoch in range(args["num_epochs"]):
        for source_image, target_image in train_dataloader:
            output = model(source_image, target_image)
            print(output)
            exit()